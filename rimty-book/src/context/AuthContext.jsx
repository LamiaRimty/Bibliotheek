...
export const AuthProvider = ({ children }) => { //pass down the authentication state (the current user) and functions (login and logout) to any child components. Inside AuthProvider,
